<?php /* views/thoi_khoa_bieu/giang_vien.php */ ?>
<div class="card">
    <div class="card-header">
        <span class="card-title"><i class="fas fa-calendar-alt" style="color:var(--clr-accent)"></i> <?= $pageTitle ?? 'Lịch giảng dạy' ?></span>
    </div>
    <div class="card-body">
        ...
        <div class="alert alert-info">
            <i class="fas fa-info-circle"></i> Không có lịch dạy trong học kỳ này.
        </div>
        <?php else: ?>
