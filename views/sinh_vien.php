<?php /* views/thoi_khoa_bieu/sinh_vien.php */ ?>
<div class="card">
    <div class="card-header">
        <span class="card-title"><i class="fas fa-calendar-alt"></i> Thời khóa biểu</span>
    </div>
    <div class="card-body">
        ...
        <?php if (empty($tkb)): ?>
        <div class="alert alert-info">Không có lịch học trong học kỳ này.</div>
        <?php else: ?>
        
        <?php $thu_map = [2=>'Thứ 2', 3=>'Thứ 3', 4=>'Thứ 4', 5=>'Thứ 5', 6=>'Thứ 6', 7=>'Thứ 7', 8=>'CN']; ?>
        
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead class="table-dark">
                    <tr><th>Thứ</th><th>Tiết</th><th>Mã môn</th><th>Tên môn học</th><th>Phòng</th><th>Giảng viên</th><th>TC</th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($lich['ma_mon']) ?></td>
